...
const TIMELINE_ITEMS = [
  {
    ...
    description: "Participated in the intense 12-hour collaborative coding and ideation sprint to draft solutions for real-world scenarios."
  },
  {
    year: "2025",
    type: "Hackathon",
    ...
    description: "Collaborated on designing and presenting technology prototypes for the prestigious national-level hackathon initiative."
  },
  {
    year: "2025",
    type: "Workshop",
    ...
    description: "Acquired hands-on exposure to core machine learning concepts, model training, and algorithmic workflows at IIT Madras Research Park."
  }
];

export function Achievements() {
  return (
    <section id="achievements" className="relative py-32 md:py-56 px-6 md:px-10 pl-12 sm:pl-16 lg:pl-10 border-t border-border">
